...
def parse():
    ...
    parser.add_argument('--config_file', type=str, default='1train/transcript_level_pred/config.py', help='the files of config')
    ...
    parser.add_argument('--log_dir', type=str, default='./results/logs/transcript_level_pred/', help='path that log will be saved')
...
def main():
    ...
    if config['mode'] == 'predict':
        ...
        trainer = Trainer(args, config)
        res = trainer.test()
        args.logger.info("Val - Loss {}  R2 {}  RMSE {}  MAE {}  Pearsonr_corr {}  Pearsonr_p {}  Spearmanr_corr {}  Spearmanr_p {} KL_divergence {}"
                        .format(
                            res[0],
                            res[1]['r2'],
                            res[1]['rmse'],
