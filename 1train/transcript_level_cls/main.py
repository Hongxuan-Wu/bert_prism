...
def parse():
    ...
    parser.add_argument('--config_file', type=str, default='1train/transcript_level_cls/config.py', help='the files of config')
    ...
    parser.add_argument('--log_dir', type=str, default='./results/logs/transcript_level_cls/', help='path that log will be saved')
